...
export default [
  ...
  { id: 'LOG-0050', timestamp: '2024-10-14T07:52:22+10:30', system: 'internal-sso', type: 'auth', severity: 'medium',
  ...
  { id: 'LOG-0051', timestamp: '2024-10-14T07:54:45+10:30', system: 'hr-portal', type: 'access', severity: 'info',
  ...
  { id: 'LOG-0052', timestamp: '2024-10-14T07:56:33+10:30', system: 'internal-wiki', type: 'access', severity: 'info',
  ...
  { id: 'LOG-0053', timestamp: '2024-10-14T08:01:11+10:30', system: 'hr-portal', type: 'access', severity: 'info',
    source: '103.42.91.17', user: 'liam.fitzgerald@xyzpay.com.au', action: 'page_view',
    message: 'Accessed HR Portal - Own Profile', details: 'Viewed: /profile/liam.fitzgerald' },
  { id: 'LOG-0054', timestamp: '2024-10-14T08:09:02+10:30', system: 'hr-portal', type: 'access', severity: 'low',
    source: '103.42.91.17', user: 'liam.fitzgerald@xyzpay.com.au', action: 'page_view',
    message: 'Accessed Finance Team Contact List', details: 'Viewed: /directory/finance' },
  { id: 'LOG-0055', timestamp: '2024-10-14T08:15:18+10:30', system: 'internal-wiki', type: 'access', severity: 'info',
    source: '103.42.91.17', user: 'liam.fitzgerald@xyzpay.com.au', action: 'page_view',
    message: 'Viewed IT Support Documentation', details: 'Page: /wiki/it-support/contact-procedures' },
  { id: 'LOG-0056', timestamp: '2024-10-14T08:22:44+10:30', system: 'hr-portal', type: 'access', severity: 'low',
    source: '103.42.91.17', user: 'liam.fitzgerald@xyzpay.com.au', action: 'page_view',
    message: 'Accessed Executive Assistant Contact Details', details: 'Viewed: /directory/executive-support' },
  { id: 'LOG-0057', timestamp: '2024-10-14T08:28:00+10:30', system: 'customer-db', type: 'access', severity: 'high',
  ...
  { id: 'LOG-0301', timestamp: '2024-10-14T07:48:44+10:30', system: 'payment-api', type: 'application', severity: 'info',
  ...
  { id: 'LOG-0302', timestamp: '2024-10-14T07:45:12+10:30', system: 'customer-portal', type: 'application', severity: 'warning',
  ...
  { id: 'LOG-0400', timestamp: '2024-10-14T07:50:01+10:30', system: 'customer-portal', type: 'auth', severity: 'low',
    source: '185.220.101.42', user: 'mike.jones@email.com', action: 'login_failed',
    message: 'Authentication failed - invalid credentials', details: 'Automated attempt detected' },
  { id: 'LOG-0401', timestamp: '2024-10-14T07:50:02+10:30', system: 'customer-portal', type: 'auth', severity: 'low',
    source: '185.220.101.42', user: 'sarah.wilson@mail.com', action: 'login_failed',
    message: 'Authentication failed - invalid credentials', details: 'Automated attempt detected' },
  { id: 'LOG-0402', timestamp: '2024-10-14T07:50:03+10:30', system: 'customer-portal', type: 'auth', severity: 'low',
    source: '185.220.101.42', user: 'david.brown@yahoo.com', action: 'login_failed',
    message: 'Authentication failed - invalid credentials', details: 'Automated attempt detected' },
  { id: 'LOG-0403', timestamp: '2024-10-14T07:50:04+10:30', system: 'customer-portal', type: 'auth', severity: 'low',
    source: '91.240.118.29', user: 'emma.taylor@gmail.com', action: 'login_failed',
    message: 'Authentication failed - invalid credentials', details: 'Automated attempt detected' },
  { id: 'LOG-0404', timestamp: '2024-10-14T07:50:05+10:30', system: 'customer-portal', type: 'auth', severity: 'low',
    source: '91.240.118.29', user: 'james.miller@outlook.com', action: 'login_failed',
    message: 'Authentication failed - invalid credentials', details: 'Automated attempt detected' },
    
  // === NORMAL BUSINESS ACTIVITY ===
  
  { id: 'LOG-0500', timestamp: '2024-10-14T07:55:22+10:30', system: 'hr-portal', type: 'access', severity: 'info',
  ...
  { id: 'LOG-0501', timestamp: '2024-10-14T07:58:11+10:30', system: 'internal-wiki', type: 'access', severity: 'info',
  ...
  { id: 'LOG-0502', timestamp: '2024-10-14T07:52:33+10:30', system: 'finance-system', type: 'access', severity: 'info',
  ...
  { id: 'LOG-0503', timestamp: '2024-10-14T07:56:45+10:30', system: 'customer-portal', type: 'access', severity: 'info',
